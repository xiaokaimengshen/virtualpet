...
from .notebookUI import notebookInterface
...
class DashboardMainWindow(FluentWindow):
    ...
    def __init__(self, minWidth=620, minHeight=600):
        ...
        self.notebookInterface = notebookInterface(sizeHintdb=(minWidth, minHeight), parent=self)
    ...
    def initNavigation(self):
        ...
        self.addSubInterface(self.animInterface,
                             ...
                             self.tr('动作'))
        self.addSubInterface(self.notebookInterface,
                             QIcon(os.path.join(basedir, "res/icons/Dashboard/manual.svg")),
                             self.tr('日记本'))
    ...
    def initWindow(self):
        ...
        self.setWindowTitle(self.tr('角色面板'))
