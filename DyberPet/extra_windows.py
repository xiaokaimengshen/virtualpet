...
class SettingUI(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        pet_list = settings.pets #json.load(open(os.path.join(basedir,'res/role/pets.json'), 'r', encoding='utf-8-sig'))
    ...
    def change_firstpet(self, pet_name):
        ...
        settings.save_settings()
        """
        pet_list = json.load(open(os.path.join(basedir,'res/role/pets.json'), 'r', encoding='utf-8-sig'))
...
class Tomato(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        if os.path.isfile(pomodoro_conf):
            self.config = json.load(open(pomodoro_conf, 'r', encoding='utf-8-sig'))
        else:
...
class Remindme(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        if os.path.isfile(os.path.join(configdir,'data/remindme.txt')):
            f = open(os.path.join(configdir,'data/remindme.txt'),'r', encoding='utf-8-sig')
            texts = f.read()
            f.close()
            texts = texts.lstrip('\n')
