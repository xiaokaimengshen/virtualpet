...
class DyberPetApp(QApplication):
    ...
    def __connectSignalToSlot(self):
        ...
        self.conp.settingInterface.dev_add_coins.connect(self.p.dev_add_coins)
        self.conp.settingInterface.dev_set_hp_zero.connect(self.p.dev_set_hp_zero)
        self.conp.settingInterface.dev_generate_today_diary.connect(self.p.dev_generate_today_diary)
        self.conp.settingInterface.dev_generate_today_diary.connect(self.board.notebookInterface.refreshDiary)
        ...
        self.note.noteToLog.connect(self.board.notebookInterface.refreshDiary)
        ...
        self.p.change_note.connect(self.board.notebookInterface.refreshDiary)
        ...
        self.acc.item_restore.connect(self.board.backpackInterface.restore_item)
        ...
        self.date_changed.connect(self.board.notebookInterface.refreshDiary)
